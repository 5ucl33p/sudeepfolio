...
I started my professional journey as a <span style={{ color: "#1E90FF" }}><strong>Web Developer Intern</strong></span> at <span style={{ color: "#1E90FF" }}><strong>JOVAC</strong></span> during my college days, where I worked on building responsive and user-friendly web applications. As part of my internship, I developed a Spotify clone using React, which helped me gain hands-on experience with component-based architecture, state management, and modern front-end development practices. This role strengthened my fundamentals in HTML, CSS, JavaScript, and React, and gave me a strong understanding of how real-world front-end projects are planned, built, and delivered.

<br></br><br></br>

Later, I joined <span style={{ color: "#1E90FF" }}><strong>Yugox</strong></span> as a <span style={{ color: "#1E90FF" }}><strong>Data Analyst Intern</strong></span> for a duration of six months, where I transitioned into working more closely with data and business insights. In this role, I worked on analyzing datasets, preparing structured reports, and supporting decision-making through data-driven insights. I also gained exposure to API-based data handling and dashboard-level analysis, which helped me understand how raw data flows from systems into reports and dashboards used by business teams.<br></br><br></br> 

Since January 2025, I have been working as an <span style={{ color: "#1E90FF" }}><strong>Associate Analyst</strong></span> at <span style={{ color: "#1E90FF" }}><strong>GlobalLogic</strong></span>, where I support data-driven business decisions by creating and maintaining dashboards and reports. My role involves analyzing performance and quality metrics, tracking key trends, and presenting insights that help stakeholders monitor productivity and improve operational efficiency. I regularly work with structured datasets, ensure data accuracy, and collaborate with team members to translate business requirements into meaningful analytical outputs.<br></br><br></br>
